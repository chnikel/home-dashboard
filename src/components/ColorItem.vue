...
const classes = {
  ...
  lime: "bg-lime-100 text-lime-800 dark:bg-lime-700 dark:text-lime-300",
  ...
  teal: "bg-teal-100 text-teal-800 dark:bg-teal-700 dark:text-teal-300",
  cyan: "bg-cyan-100 text-cyan-800 dark:bg-cyan-700 dark:text-cyan-300",
  sky: "bg-sky-100 text-sky-800 dark:bg-sky-700 dark:text-sky-300",
  ...
  rose: "bg-rose-100 text-rose-800 dark:bg-rose-700 dark:text-rose-300",
  ...
  stone: "bg-stone-100 text-stone-800 dark:bg-stone-700 dark:text-stone-300",
};
